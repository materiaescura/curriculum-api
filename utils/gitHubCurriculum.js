...
const getRepos = async ({username, hiddenRepositories, per_page}) => {
...
const gitHubCurriculum = async ({username, hiddenRepositories,per_page}) => {
    const user = await getUser(username)
    const repos = await getRepos({username, hiddenRepositories, per_page})
